...
\multicolumn{3}{|l|}{A) Jaccard similarity of CAT annotations of hg19 vs. GENCODE} \\ \hline
Annotation pair & Exon Jaccard similarity & Intron Jaccard similarity \\ \hline
CAT/GENCODEV27lift37 & 0.617 & 0.836 \\ \hline
\multicolumn{3}{|l|}{B) ICE isoform validation of human annotations} \\ \hline
...
ProgressiveCactus alignments take on the order of 120 CPU days (2,880 core hours) per internal node on the guide tree, assuming a binary tree. This number can fluctuate by a factor of 2-4 depending on how similar the two genomes being aligned at that node are. ProgressiveCactus alignments are a mix of high CPU low memory steps with a few high memory steps, with some jobs requiring \~240GB of RAM.
