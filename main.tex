...
We would like to thank David Gordon for developing the indel error correction approach, Brian Raney, Hiram Clawson and the rest of the UCSC Browser team for help creating browser tracks, and Dent Earl, whose work led to this project. We also would like to thank Fergal Martin and Paul Flicek for revising the paper and providing a pre-release of the Ensembl V91 annotations on chimpanzee and gorilla.
